...
//     cvCvtColor(raw_mat, imDisplay, CV_RGB2BGR);
    ...
    if (lanesConf.ransacLine && lanesConf.ransacSpline)
      ...
      //{
         ...
         // SHOW_IMAGE(imDisplay, "Detected Lanes", 30);
      //}
...
/*    ProcessImage(options.image_file_arg, cameraInfo, lanesConf, stoplinesConf,
    ...
    ProcessImage("../caltech-lanes/cordova1/f00000.png", cameraInfo, lanesConf, stoplinesConf,
        options, NULL, elapsed, 0);
...
/*        ProcesfilenamesImage(imageFile.c_str(), cameraInfo, lanesConf, stoplinesConf,
        ...
        ProcessImage(name, cameraInfo, lanesConf, stoplinesConf,
